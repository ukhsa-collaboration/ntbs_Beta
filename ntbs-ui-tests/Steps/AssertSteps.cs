        ...
        private string[] GetExpectedLabels(string tableId)
        {
            return tableId switch
            {
                ...
                "ClinicalDetails" => new [] { "Sites of disease", "Patient has symptoms", "Symptom onset date",
                    ...
                    "Symptom onset to health service presentation", "Healthcare setting", 
                    "Referral to TB service received date", "Health service presentation to TB service referral received",
                    "Presentation to TB service date","Referral received to TB service presentation",
                    "Diagnosis date", "TB service presentation to diagnosis",
