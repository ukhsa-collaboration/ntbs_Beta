Feature: Notification input errors
  ...
  Scenario: Clinical date verification shows correct warnings
    ...
    When I enter 9 into 'FormattedFirstPresentationDate_Day'
    And I enter 11 into 'FormattedFirstPresentationDate_Month'
    And I enter 2012 into 'FormattedFirstPresentationDate_Year'
    When I enter 16 into 'FormattedTbServicePresentationDate_Day'
    And I enter 10 into 'FormattedTbServicePresentationDate_Month'
    And I enter 2012 into 'FormattedTbServicePresentationDate_Year'
    ...
    When I enter 9 into 'FormattedFirstPresentationDate_Day'
    And I enter 6 into 'FormattedFirstPresentationDate_Month'
    And I enter 2012 into 'FormattedFirstPresentationDate_Year'
    When I enter 11 into 'FormattedDiagnosisDate_Day'
    And I enter 9 into 'FormattedDiagnosisDate_Month'
    And I enter 2012 into 'FormattedDiagnosisDate_Year'
    ...
    And I enter 30 into 'FormattedTreatmentDate_Day'
    And I enter 8 into 'FormattedTreatmentDate_Month'
    And I enter 2012 into 'FormattedTreatmentDate_Year'
    ...
    And I enter 9 into 'FormattedHomeVisitDate_Month'
    And I enter 2012 into 'FormattedHomeVisitDate_Year'
    Then I see the warning 'First home visit date is earlier than Diagnosis date' for 'date-warning-text-5'

    When I check 'home-visit-yes'
    And I enter 20 into 'FormattedHomeVisitDate_Day'
