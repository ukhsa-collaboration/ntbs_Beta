...
namespace ntbs_ui_tests.Helpers
{
    public static class Utilities
    {
        ...
        public const int M_BOVIS_NOTIFICATION = 10003;
            ...
            return new List<Notification>
            {
                new Notification
                {
                    ...
                    NotificationSites = new List<NotificationSite>
                    {
                        ...
                        {
                            NotificationId = TO_BE_DENOTIFIED_ID, SiteId = (int)SiteId.PULMONARY
                        }
                    }
                },
                new Notification
                {
                    NotificationId = M_BOVIS_NOTIFICATION,
                    NotificationStatus = NotificationStatus.Notified,
                    NotificationSites = new List<NotificationSite>
                    {
                        new NotificationSite
                        {
                            NotificationId = M_BOVIS_NOTIFICATION, SiteId = (int)SiteId.PULMONARY
                        }
                    },
