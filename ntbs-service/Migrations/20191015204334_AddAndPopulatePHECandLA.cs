...
{
    public partial class AddAndPopulatePHECandLA : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PHECCode = table.Column<string>(maxLength: 50, nullable: false),
                    LocalAuthorityCode = table.Column<string>(maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "PHECNI", "Northern Ireland" },
                    { "E45000020", "South West" },
                    { "E45000019", "South East" },
                    { "E45000018", "North West" },
                    { "E45000017", "East of England" },
                    { "E45000010", "Yorkshire and Humber" },
                    { "E45000009", "North East" },
                    { "E45000005", "West Midlands" },
                    { "E45000001", "London" },
                    { "PHECSCOT", "Scotland" },
                    { "E45000016", "East Midlands" },
                    { "PHECWAL", "Wales" }
                });

            migrationBuilder.InsertData(
                table: "LocalAuthorityToPHEC",
                columns: new[] { "PHECCode", "LocalAuthorityCode" },
                values: new object[,]
                {
                    { "E45000001", "E09000001" },
                    { "E45000020", "E06000022" },
