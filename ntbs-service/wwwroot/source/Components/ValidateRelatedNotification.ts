    ...
    methods: {
        ...
        tryGetNotification: function (id: string) {
            ...
            axios.request(requestConfig)
                .then((response: any) => {
                    var validationMessage = response.data;
                    if (typeof validationMessage == 'string' && validationMessage) {
                        ...
                        this.$refs["errorField"].textContent = validationMessage;
                        ...
                        this.relatedNotification = validationMessage ? validationMessage : {};
                        this.isValid = validationMessage != '';
                    }
                })
                .catch((error: any) => {
