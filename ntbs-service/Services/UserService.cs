...
namespace ntbs_service.Services
{
    ...
    public class UserService : IUserService
    {
        ...
        async public Task<UserPermissionsFilter> GetUserPermissionsFilterAsync(ClaimsPrincipal user)
        {
        ...
        async public Task<TBService> GetDefaultTBService(ClaimsPrincipal user)
        {
