...

{
    public class DataQualityPotentialDuplicateAlert : Alert
    {
        ...
        public override string Action => NhsNumberMatch ? $"This record may be a duplicate of {DuplicateId}. Please contact the case manager to discuss."
            : $"This record may be a duplicate of {DuplicateId}, however the NHS numbers do not match. Please contact the case manager to discuss.";
