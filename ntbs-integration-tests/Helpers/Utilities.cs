...
namespace ntbs_integration_tests.Helpers
{
    public static class Utilities
    {
        ...
        public const int LINKED_NOTIFICATION_ABINGDON_TB_SERVICE = 97;
        public const int LINK_NOTIFICATION_ROYAL_FREE_LONDON_TB_SERVICE = 98;

        public const int PATIENT_NOTIFICATION_GROUP_ID = 101;
        public const int OVERVIEW_NOTIFICATION_GROUP_ID = 102;
